(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('cross-fetch'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['exports', 'cross-fetch', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Iota2 = {}, global['cross-fetch'], global.crypto));
}(this, (function (exports, fetch, crypto) { 'use strict';
    ...
    */
    ...
    var ED25519 = /** @class */ (function () {
        ...
        ED25519.keyPairFromSeed = function (seed) {
            var signKeyPair = undefined(seed);
            return {
        ...
        ED25519.privateSign = function (keyPair, buffer) {
            return Buffer.from(undefined(buffer, keyPair.secretKey));
        };
        /**
