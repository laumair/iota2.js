(function (global, factory) {
	...
	*/
	...
	const MIN_MESSAGE_LENGTH = common.BYTE_SIZE +
	    ...
	    common.UINT64_SIZE;
	const EMPTY_MESSAGE_ID_HEX = "0".repeat(common.MESSAGE_ID_LENGTH * 2);
	/**
	...
	function serializeMessage(writeBuffer, object) {
	    ...
	    writeBuffer.writeFixedBufferHex("message.parent1MessageId", common.MESSAGE_ID_LENGTH, (_a = object.parent1MessageId) !== null && _a !== void 0 ? _a : EMPTY_MESSAGE_ID_HEX);
	    writeBuffer.writeFixedBufferHex("message.parent2MessageId", common.MESSAGE_ID_LENGTH, (_b = object.parent2MessageId) !== null && _b !== void 0 ? _b : EMPTY_MESSAGE_ID_HEX);
	    payload.serializePayload(writeBuffer, object.payload);
	...
	function getUnspentAddresses(client, seed, basePath, startIndex, countLimit) {
	    return __awaiter(this, void 0, void 0, function* () {
	        ...
	        do {
	            ...
	            basePath.pop();
	            const addr = ed25519.Ed25519.publicKeyToAddress(addressKeyPair.publicKey);
	...
	function sendAdvanced(client, seed, basePath, outputs, startIndex, indexationKey, indexationData) {
	    return __awaiter(this, void 0, void 0, function* () {
	        ...
	        do {
	            ...
	            const addressKeyPair = seed.generateSeedFromPath(basePath).keyPair();
	            basePath.pop();
	            const address = ed25519.Ed25519.publicKeyToAddress(addressKeyPair.publicKey);
