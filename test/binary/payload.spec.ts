...
describe("Binary Payload", () => {
    ...
    test("Can succeed with valid milestone data", () => {
        ...
        buffer.write("2c59d43952bda7ca60d3c2288ebc00703b4b60c928d277382cad5f57b02a90825f2d3a8509d6594498e0488f086d8fa3f13d9636d20e759eb5806ffe663bac0d", 88, "hex"); // Signature
    ...
    test("Can serialize and deserialize milestone payload", () => {
        const payload: IMilestonePayload = {
            ...
            signature: "8cba2c84d06b378736681305d3fcf11698c5d3cb45dd6146ea47e0d26bddca03887501858ab4c803d7db8c09f5c6f5bec87aade06b6f4de6c050c07fede4cb04"
        };
        ...
        expect(deserialized.signature).toEqual("8cba2c84d06b378736681305d3fcf11698c5d3cb45dd6146ea47e0d26bddca03887501858ab4c803d7db8c09f5c6f5bec87aade06b6f4de6c050c07fede4cb04");
    });
});
