...
describe("Binary Signature", () => {
    ...
    test("Can serialize and deserialize ed25519 signature", () => {
        ...
        const hex = serialized.finalBuffer().toString("hex");
        expect(hex).toEqual("6920b176f613ec7be59e68fc68f597eb3393af80f74c7c3db78198147d5f1f922c59d43952bda7ca60d3c2288ebc00703b4b60c928d277382cad5f57b02a90825f2d3a8509d6594498e0488f086d8fa3f13d9636d20e759eb5806ffe663bac0d");
